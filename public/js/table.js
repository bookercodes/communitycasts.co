...
function technologiesFormatter(value, row) {
  var html = "<i class='fa fa-folder-o'/> <a href='/technologies/"+ encodeURIComponent(row.technologies[0]) + "' title='Tag 1'>{technology1}</a>";
  if (row.technologies[1] != null)
    html += " <a href='technologies/" + encodeURIComponent(row.technologies[0]) +"'  title='Tag 2'>{technology2}</a>";
